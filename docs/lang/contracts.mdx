...
Contracts are also namespaces, so they can contain static definitions for custom types and functions which can be referenced in other code.
It is common to define custom **errors** and **events** inside a contract.
